...
static const AVOption options[] = {
    ...
    { "dx9",            "DirectX9",                             0,                  AV_OPT_TYPE_CONST, { .i64 = AMF_VIDEO_ENCODER_ENGINE_DX9    },      0, 0, VE, "engine" },
    { "dx11",           "DirectX11",                            0,                  AV_OPT_TYPE_CONST, { .i64 = AMF_VIDEO_ENCODER_ENGINE_DX11   },      0, 0, VE, "engine" },
